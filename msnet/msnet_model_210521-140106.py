...
class msNet(nn.Module):
    def __init__(self, n_channels=3, n_classes=1):
        ...
        self.conv1 = DoubleConv(n_channels, 64)
        self.conv2 = DoubleConv(64, 128) #1/2
        self.conv3 = DoubleConv(128, 256) #1/4
        self.conv4 = DoubleConv(256, 512) #1/8
        self.conv5 = DoubleConv(512, 512) #1/16

        self.wav2 = waveT(2) ## added by @dv
        self.invWav = invWaveT('haar') ## added by @dv
    ...
    def forward(self, x,w):
        ...
        w21 = self.wav2(conv1)
        down1 = self.invWav([w21['cA2'], [w21['cH2'],w21['cV2'],w21['cD2']]])
        conv2 = self.conv2(down1)#1/2 #
        
        w22 = self.wav2(conv2)
        down2 = self.invWav([w22['cA2'], [w22['cH2'],w22['cV2'],w22['cD2']]])
        conv3 = self.conv3(down2)#1/4 #256
        
        w23 = self.wav2(conv3)
        down3 = self.invWav([w23['cA2'], [w23['cH2'],w23['cV2'],w23['cD2']]])
        conv4 = self.conv4(down3)#1/8 #512
        
        w24 = self.wav2(conv4)
        down4 = self.invWav([w24['cA2'], [w24['cH2'],w24['cV2'],w24['cD2']]])
        conv5 = self.conv5(down4)#1/16 #512
