...
class msNet(nn.Module):
    def __init__(self, n_channels=3, n_classes=1):
        ...
        self.wav1 = waveT(1,'haar') ## added by @dv
        self.wav2 = waveT(2,'haar') ## added by @dv
        self.wav3 = waveT(3,'haar') ## added by @dv
        self.wav4 = waveT(4,'haar') ## added by @dv
        
        self.fusew_2 = nn.Conv2d(4, 1, 1)
        self.fusew_3 = nn.Conv2d(7, 1, 1)
        self.fusew_4 = nn.Conv2d(10, 1, 1)
        #self.fusew_5 = nn.Conv2d(2, 1, 1)
        self.fusew_5 = nn.Conv2d(13, 1, 1) # @dv: added
        # Upsample
    ...
    def forward(self, x,w):
        ...
        if w is not None:
            ...
            fcat_3=torch.cat((so33, w1['cH2'],w1['cV2'], w1['cD2'],
                              w2['cH1'],w2['cV1'], w2['cD1']), dim=1)
            so3 =self.fusew_3(fcat_3)
            w3 = self.wav2(so3)
            
            so44 = self.dsn4(conv4)#1/8
            fcat_4=torch.cat((so44, w1['cH3'],w1['cV3'], w1['cD3'],
                              w2['cH2'],w2['cV2'], w2['cD2'],
                              w3['cH1'],w3['cV1'], w3['cD1']), dim=1)
            so4 =self.fusew_4(fcat_4)
            w4 = self.wav1(so4)

            so5 = self.dsn5(conv5)#1/16
            fcat_5=torch.cat((so5, w1['cH4'],w1['cV4'], w1['cD4'],
                              w2['cH3'],w2['cV3'], w2['cD3'],
                              w3['cH2'],w3['cV2'], w3['cD2'],
                              w4['cH1'],w4['cV1'], w4['cD1']), dim=1) # @dv: added
