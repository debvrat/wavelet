...
class msNet(nn.Module):
    ...
    def forward(self, x,w):
        ...
        conv2 = self.conv2(self.wav1(conv1)['cA1'])#1/2 #128
        conv3 = self.conv3(self.wav1(conv2)['cA1'])#1/4 #256
        conv4 = self.conv4(self.wav1(conv3)['cA1'])#1/8 #512
        conv5 = self.conv5(self.wav1(conv4)['cA1'])#1/16 #512
